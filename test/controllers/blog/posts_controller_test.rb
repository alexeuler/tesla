...
class Blog::PostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('Blog::Post.count') do
      post :create, blog_post: { header: @blog_post.header, page: @blog_post.page, route: @blog_post.route, tag: @blog_post.tag }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { header: @blog_post.header, page: @blog_post.page, route: @blog_post.route, tag: @blog_post.tag }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
